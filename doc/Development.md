# Development and Testing Guide <br/> Pip.Services AWS for .NET
...
```bash
nuget pack pip-services3-aws-dotnet.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.Aws.<version>.nuspec -Source https://www.nuget.org/api/v2/package
```
